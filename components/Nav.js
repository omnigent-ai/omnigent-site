    ...
    <header className="nav">
      <div className="nav-inner">
        ...
        <Link href="/" className="brand">
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img className="theme-dark-only" src="/images/logo-dark.svg" alt="Omnigent" height={45} width={172} />
        </Link>
        <nav className="nav-links">
          <Link href="/quickstart/install" className="nav-link">Get Started</Link>
          <Link href="/docs/use/coding-agents" className="nav-link">Docs</Link>
