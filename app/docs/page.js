...
export default function Page() {
  return (
    <>
      ...
      <ul>
        <li><strong>Use Cases:</strong> run coding agents, try built-in multi-AI agents (Polly, Debby), build your own custom agent, and pick your interface: terminal, web UI, mobile, or desktop app.</li>
