...
export const metadata = pageMeta(
  ...
  "Tutorial: see what Omnigent adds on top of Claude Code or Codex, including a web UI, mobile access, persistent sessions, and session sharing.",
  {
    eyebrow: "Quickstart",
...
Pick whichever you already use. Either command launches the coding agent in
your terminal and prints the web UI URL, normally `http://localhost:6767`. Open
it to view the same session and stream output in real time.
