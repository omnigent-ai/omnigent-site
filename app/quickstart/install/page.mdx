...
You can connect a direct API key, an existing provider subscription, a gateway
like OpenRouter, or a Databricks workspace.

See [Models & Credentials](/docs/build/models#credentials) for all supported providers.

## Auto-discover skills, MCPs, and more

Omnigent scans your existing developer environment and picks up what's already
there. Skills, MCP configurations, and session history from Claude Code,
Codex, Cursor, and others carry over automatically.
