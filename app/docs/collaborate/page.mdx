...
<ul>
  <li>
    ...
    <ul>
      ...
      <li>
        To open the session on a phone, click <strong>Open in mobile app</strong>{" "}
        in the Share modal for a QR code your teammate can scan. See{" "}
        <Link href="/docs/interact/mobile#scan-to-open-in-the-app">
