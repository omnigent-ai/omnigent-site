...
provider authentication, and launch steps. To add a provider from a separate
Python package, see [Community Sandbox Providers](/docs/deploy/community-sandbox-providers).
