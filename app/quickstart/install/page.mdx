...
changing anything. The older `omni update` spelling is **deprecated**: it still
runs the upgrade, but prints a deprecation warning and points you at
`omni upgrade`. Use `omni upgrade` directly.
