          ...
          <section className="section">
            ...
            <div className="arch-parts">
              <div className="arch-part">
                <p>
                  <strong>Runner</strong> wraps any agent in a sandboxed, uniform
                  session.
                </p>
              </div>
              <div className="arch-part">
                <p>
                  <strong>Server</strong> adds policies, a shared history, and a
                  catalog of MCPs, artifacts, and skills.
                </p>
              </div>
            </div>
            <p className="arch-outro">
              Because everything sits behind one interface, every session is
              reachable from the terminal, the web, your phone, and a REST API.
            </p>
