...
| -------------- | ---------------------------------------------- |
| `request`      | A user request enters the session              |
| `tool_call`    | Omnigent is about to call a tool               |
| `tool_result`  | A tool returns a result                        |
| `response`     | Omnigent produces an assistant response        |
| `llm_request`  | Omnigent is about to send a request to the LLM |
| `llm_response` | The LLM returns a response                     |
