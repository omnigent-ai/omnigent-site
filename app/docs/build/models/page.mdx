...
In the web UI you can also switch the model (and effort, or turn on Smart
Routing) from the composer's **gear** (⚙) — see
[Run configuration](/docs/interact/web-ui#run-configuration). Typing a bare
`/model` there opens the same modal.
