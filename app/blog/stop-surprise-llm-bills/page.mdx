...
export const metadata = pageMeta(
  ...
  "How Omnigent keeps LLM spend predictable: smart routing, progressive budgets, custom pricing for self-hosted models, and per-model usage tracking.",
  {
    eyebrow: "Blog",
...
Routing cuts expensive model calls, but real workflows still burn tokens. Omnigent's [contextual policy system](/blog/omnigent-policies) adds budgets that warn before they block.
...
- [Allow, ask, deny: contextual policies in Omnigent](/blog/omnigent-policies): how the policy system works
- [Organize your sessions into projects](/blog/first-class-projects-with-defaults): keep related sessions organized with default settings
