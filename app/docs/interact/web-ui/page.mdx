...
CLI install or sign-in, or a [Native TUI
harness](/docs/build/harnesses/supported#native-tui-on-windows-hosts) when the
selected host runs Windows) so you can discover and configure them. If you'd rather
