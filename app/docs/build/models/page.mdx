...
For the Pi harness, a gateway provider's `models:` tier map can scope the
`/model` picker to a curated shortlist — see
[Pi configuration](/docs/build/harnesses/configuration#pi).
