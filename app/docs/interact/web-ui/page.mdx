...
On a Databricks-hosted deployment the **Mode** (light or dark) is configured in
your Databricks user preferences rather than toggled in the web UI. In that case
the Appearance panel points you to those preferences with a link to open your
Databricks user preferences page; the **Color theme** dropdown still works as
described above.
