...
To bind individual harnesses to different inference gateways and curate the
model list shown in the composers, add `inference.harnesses` to
`sandbox.host_config` — see
