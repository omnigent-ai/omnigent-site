  ...
  return (
    <>
      ...
      <p>
        ...
        the link to your teammate. Share grants one of two permission levels: <strong>VIEW</strong>{" "}
        (read-only — teammates watch the session stream) or <strong>EDIT</strong> (teammates can
        co-drive and send messages). Teammates see everything in real time: messages, tool calls, and
