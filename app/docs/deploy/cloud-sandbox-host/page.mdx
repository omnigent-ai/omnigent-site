...
Omnigent supports Modal, Daytona, Blaxel, Islo, Boxlite, CoreWeave Sandbox,
E2B, OpenShell, and Kubernetes as server-managed sandbox providers.
...
pip install 'omnigent[kubernetes]'  # for Kubernetes
```
...
```
omni sandbox create --provider modal
