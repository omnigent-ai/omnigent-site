...
1. Open the app and enter a server URL. `omni debby` prints one when it
   starts the web UI, usually `http://localhost:6767`. Paste it into the app
   to connect.
2. Pick **Debby** from the agent picker and ask it anything.
